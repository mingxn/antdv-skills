---
name: input-number
description: InputNumber - Enter a number within certain range with the mouse or keyboard.
---
...
Use via `theme.components.InputNumber` in ConfigProvider.
...
| `handleVisible` | `'auto' \| true` | Default `auto`. Set `true` will always show the handle |
