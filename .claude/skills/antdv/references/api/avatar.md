---
name: avatar
description: Avatar - Avatars can be used to represent people or objects. It supports images, `Icon`s, or letters.
---
...
Use via `theme.components.Avatar` in ConfigProvider.

| Token | Type | Description |
| --- | --- | --- |
| `containerSize` | `number` | Background color of Avatar |
